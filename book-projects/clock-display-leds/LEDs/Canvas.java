...
/**
 * This Canvas is an extension of the Canvas used in the figures project.
 *
...
public class Canvas
{
    ...
    {    
        ...
        else if(colorString.equals("led")) {
            graphic.setColor(new Color(236, 46, 23));
        }
        else if(colorString.equals("led_back")) {
            graphic.setColor(new Color(53, 9, 9));
        }
